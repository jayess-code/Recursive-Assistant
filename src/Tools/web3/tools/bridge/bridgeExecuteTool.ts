...
import { bridgeExecute, BridgeExecuteToolArgs } from "./bridge";
...
const parameters: ToolParameters = {
  ...
  properties: {
    ...
    dryRun: {
      ...
      nullable: true,
      default: false,
      description: "When true, validates and simulates execution without submitting transactions.",
    },
  },
};

export const bridgeExecuteTool: ToolConfig<BridgeExecuteToolArgs> = {
  tool: {
    type: "function",
    name: "bridge_execute",
    description:
      "Execute a bridge route via auto provider selection. Supports dryRun preview and returns tx hashes when submitted.",
    parameters,
    strict: true,
  ...
  info: {
    ...
    provider: "onchain",
    version: "1.0.0",
    definition: "Bridge execution tool for V1/V2 Stargate-aware routing with optional dryRun mode.",
  },
};
