...
import { loadOllamaRuntimeConfig } from "./ollamaConfig.js";
import { getLatestToolResult, isPlaceholderToolResponse, normalizeAssistantTools } from "./ollamaMessageUtils.js";
import { buildOllamaRequestPolicy, buildOllamaSystemPrompt } from "./ollamaRequestPolicy.js";
import { buildOllamaChatMessages, executeNonStreamingRequest, executeRetryNonStream, executeRetryWithoutTools, executeStreamingRequest, streamTextByChunks } from "./ollamaSendHelpers.js";
...
export class OllamaProvider extends BaseProvider implements LLMProvider {
  ...
  async send(context: LLMContext): Promise<LLMResponse> {
    ...
    // const chatMessages: any[] = EXAMPLE_CONTEXT.messages;
